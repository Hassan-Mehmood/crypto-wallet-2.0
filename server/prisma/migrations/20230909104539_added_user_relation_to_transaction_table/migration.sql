...
INSERT INTO "new_Transaction" ("coinId", "costBasis", "createdAt", "id", "price", "quantity", "timeBought", "type", "updatedAt") SELECT "coinId", "costBasis", "createdAt", "id", "price", "quantity", "timeBought", "type", "updatedAt" FROM "Transaction";
