/*
  ...
  - You are about to drop the column `costBasis` on the `Coin` table. All the data in the column will be lost.
  - Added the required column `totalCostBasis` to the `Coin` table without a default value. This is not possible if the table is not empty.
