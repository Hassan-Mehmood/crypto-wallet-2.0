...
INSERT INTO "new_Coin" ("apiSymbol", "averageBuyPrice", "createdAt", "id", "large", "marketCapRank", "name", "symbol", "thump", "totalQuantity", "updatedAt", "userId") SELECT "apiSymbol", "averageBuyPrice", "createdAt", "id", "large", "marketCapRank", "name", "symbol", "thump", "totalQuantity", "updatedAt", "userId" FROM "Coin";
DROP TABLE "Coin";
