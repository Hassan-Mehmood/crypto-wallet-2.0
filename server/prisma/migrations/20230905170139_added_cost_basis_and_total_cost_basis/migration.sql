/*
  ...
  - Added the required column `costBasis` to the `Coin` table without a default value. This is not possible if the table is not empty.
  - Added the required column `costBasis` to the `Transaction` table without a default value. This is not possible if the table is not empty.
