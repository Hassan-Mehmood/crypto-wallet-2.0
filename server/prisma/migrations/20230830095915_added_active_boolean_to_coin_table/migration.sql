/*
  ...
  - Added the required column `active` to the `Coin` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Coin" ("apiSymbol", "averageBuyPrice", "createdAt", "holdingsInDollers", "id", "large", "latestPrice", "marketCapRank", "name", "profitLoss", "symbol", "thump", "totalInvestment", "totalQuantity", "updatedAt", "userId") SELECT "apiSymbol", "averageBuyPrice", "createdAt", "holdingsInDollers", "id", "large", "latestPrice", "marketCapRank", "name", "profitLoss", "symbol", "thump", "totalInvestment", "totalQuantity", "updatedAt", "userId" FROM "Coin";
DROP TABLE "Coin";
